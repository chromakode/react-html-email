...
function Item(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'td',
      _extends({}, (0, _includeDataProps2.default)(props), { className: props.className, align: props.align, valign: props.valign, bgcolor: props.bgcolor, style: props.style, dir: props.dir }),
      props.children
    )
  );
}
